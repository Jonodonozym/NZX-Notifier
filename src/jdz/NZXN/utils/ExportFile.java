...
public class ExportFile {
     ...
     * Taken from https://stackoverflow.com/questions/10308221/how-to-copy-file-inside-jar-to-outside-the-jar
    ...
    static public String ExportResource(String resourcePath, String targetPath) throws Exception {
        ...
        try {
            ...
            stream = ExportFile.class.getResourceAsStream(resourcePath);//note that each / is a directory down in the "jar tree" been the jar the root of the tree
            if(stream == null) {
